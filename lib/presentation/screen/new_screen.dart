...
class _PhoneAuthPageState extends State<PhoneAuthPage> {
  ...
  _verifyOTPButton() async {
    PhoneAuthCredential phoneAuthCredential = PhoneAuthProvider.credential(verificationId: verificationIDFromFirebase.toString(), smsCode: otpController.text);
  ...
  void signInWithPhoneAuthCredential(PhoneAuthCredential phoneAuthCredential) async {
    ...
    try {
      final authCredential = await _firebaseAuth.signInWithCredential(phoneAuthCredential);
      setState(() {
        spinnerLoading = false;
      });
    ...
    return Column(
      children: [
        ...
        TextField(
          ...
          decoration: const InputDecoration(hintText: "Phone Number", prefixIcon: Icon(Icons.phone_android_rounded)),
        ),
        const SizedBox(
          height: 20.0,
        ),
    ...
    return Column(
      children: [
        ...
        TextField(
          ...
          textAlign: TextAlign.start,
          decoration: const InputDecoration(hintText: "OTP Number", prefixIcon: Icon(Icons.confirmation_number_rounded)),
        ),
        const SizedBox(
          height: 20.0,
        ),
