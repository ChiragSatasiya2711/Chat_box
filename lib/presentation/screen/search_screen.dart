...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void filter(String inputString) {
    global.fooList = global.filteredList.where((i) => i.toLowerCase().contains(inputString)).toList();
        ...
        child: Column(
          children: [
            ...
            TextField(
              ...
              onChanged: (text) {
                if (global.searchController.text.isEmpty) {
                  debugPrint("======+++++====++++=====>${global.fooList}");
                }
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) => Card(
                        ...
                        child: ListTile(
                          ...
                          title: Text(global.fooList[index], style: const TextStyle(fontWeight: FontWeight.w500)),
                          subtitle: Text(
                            AppList.newUser[index]["data2"],
                            style: TextStyle(color: AppColor.black10, fontSize: 12),
                          ),
                          onTap: () {
                            debugPrint("========add____----${global.fooList[index]}");
